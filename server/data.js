...
const pitches = [
  {
    ...
    title: "Telus",
    caption:
      "At TELUS, our purpose-driven team works together every day to innovate and do good.",
    videoUrl: "http://localhost:5002/uploads/Telus_Video.mp4",
    photo: "http://localhost:5002/uploads/Telus.svg",
    companyInfo:
      "We are developing cutting-edge AI to revolutionize the tech industry.",
  ...
  },
  {
    ...
    companyInfo:
      "A fitness app focused on providing customized home workout plans.",
  ...
  },
  {
    ...
    companyInfo:
      "We provide innovative solar energy solutions for residential homes.",
    ownerId: "user3", // John Doe owns this pitch
    messages: [],
  },
  {
    ...
    companyInfo:
      "An AI-powered platform to streamline the hiring process for startups.",
    ownerId: "user2", // Sarah Smith owns this pitch
    messages: [
      {
        id: "msg4",
